...
CSRF_TRUSTED_ORIGINS = ["https://localhost:8000", "https://127.0.0.1:8000", "https://neat-coats-bow.loca.lt"]
...
ROOT_URLCONF = "recall_server.config.urls"
...
WSGI_APPLICATION = "recall_server.config.wsgi.application"
